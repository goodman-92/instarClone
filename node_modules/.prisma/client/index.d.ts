...
export namespace Prisma {
  ...
  */
  ...
  export type PhotoGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: PhotoCountAggregateInputType | true
    avg?: PhotoAvgAggregateInputType
    sum?: PhotoSumAggregateInputType
    min?: PhotoMinAggregateInputType
    max?: PhotoMaxAggregateInputType
  ...
  type GetPhotoGroupByPayload<T extends PhotoGroupByArgs> = Promise<Array<
    PickArray<PhotoGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof PhotoGroupByOutputType))]: GetScalarType<T[P], PhotoGroupByOutputType[P]>
    }
  >>
  ...
  export type PhotoGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends 'hashtags'
        ? Array < HashTagGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'hashtags'
        ? Array < HashTagGetPayload<S['select'][P]>>  : never
  } 
    : Photo
  : Photo
  ...
  export type HashTagGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: HashTagCountAggregateInputType | true
    avg?: HashTagAvgAggregateInputType
    sum?: HashTagSumAggregateInputType
    min?: HashTagMinAggregateInputType
    max?: HashTagMaxAggregateInputType
  ...
  type GetHashTagGroupByPayload<T extends HashTagGroupByArgs> = Promise<Array<
    PickArray<HashTagGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof HashTagGroupByOutputType))]: GetScalarType<T[P], HashTagGroupByOutputType[P]>
    }
  >>
  ...
  export interface HashTagDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, HashTagGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHashTagGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type UserWhereInput = {
    ...
    craetedAt?: DateTimeFilter | Date | string
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    craetedAt?: DateTimeWithAggregatesFilter | Date | string
  ...
  export type HashTagCreateNestedManyWithoutPhotosInput = {
    create?: XOR<Enumerable<HashTagCreateWithoutPhotosInput>, Enumerable<HashTagUncheckedCreateWithoutPhotosInput>>
  ...
  export type PhotoCreateNestedManyWithoutHashtagsInput = {
    create?: XOR<Enumerable<PhotoCreateWithoutHashtagsInput>, Enumerable<PhotoUncheckedCreateWithoutHashtagsInput>>
  ...
  export type PhotoCreateManyUserInputEnvelope = {
    data: Enumerable<PhotoCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type HashTagCreateOrConnectWithoutPhotosInput = {
    where: HashTagWhereUniqueInput
    create: XOR<HashTagCreateWithoutPhotosInput, HashTagUncheckedCreateWithoutPhotosInput>
  }
  ...
  export type HashTagUpsertWithWhereUniqueWithoutPhotosInput = {
    where: HashTagWhereUniqueInput
    update: XOR<HashTagUpdateWithoutPhotosInput, HashTagUncheckedUpdateWithoutPhotosInput>
    create: XOR<HashTagCreateWithoutPhotosInput, HashTagUncheckedCreateWithoutPhotosInput>
  }

  export type HashTagUpdateWithWhereUniqueWithoutPhotosInput = {
    where: HashTagWhereUniqueInput
    data: XOR<HashTagUpdateWithoutPhotosInput, HashTagUncheckedUpdateWithoutPhotosInput>
  }
  ...
  export type PhotoCreateOrConnectWithoutHashtagsInput = {
    where: PhotoWhereUniqueInput
    create: XOR<PhotoCreateWithoutHashtagsInput, PhotoUncheckedCreateWithoutHashtagsInput>
  }

  export type PhotoUpsertWithWhereUniqueWithoutHashtagsInput = {
    where: PhotoWhereUniqueInput
    update: XOR<PhotoUpdateWithoutHashtagsInput, PhotoUncheckedUpdateWithoutHashtagsInput>
    create: XOR<PhotoCreateWithoutHashtagsInput, PhotoUncheckedCreateWithoutHashtagsInput>
  }

  export type PhotoUpdateWithWhereUniqueWithoutHashtagsInput = {
    where: PhotoWhereUniqueInput
    data: XOR<PhotoUpdateWithoutHashtagsInput, PhotoUncheckedUpdateWithoutHashtagsInput>
  }
